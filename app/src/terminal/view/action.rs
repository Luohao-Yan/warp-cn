...
impl fmt::Debug for TerminalAction {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        ...
        match self {
            ...
            Paste => f.write_str(crate::tr!("common", "paste-label").as_str()),
            Copy => f.write_str(crate::tr!("common", "copy-label").as_str()),
            ...
            Close => f.write_str(crate::tr!("common", "close-label").as_str()),
