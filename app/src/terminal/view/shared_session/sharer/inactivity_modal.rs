...
impl InactivityModalBody {
    ...
    fn render_countdown(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let minutes = (self.duration.as_secs() / 60) as i64;
        let text = crate::tr!("terminal", "sharing-will-end-due-to-inactivity", minutes = minutes, seconds = format!("{secs:02}"));
    ...
    fn render_stop_sharing_button(&self, appearance: &Appearance) -> Box<dyn Element> {
        Container::new(
            appearance
                ...
                .with_centered_text_label(crate::tr!("terminal", "stop-sharing"))
                .build()
    ...
    fn render_continue_sharing_button(&self, appearance: &Appearance) -> Box<dyn Element> {
        appearance
            ...
            .with_centered_text_label(crate::tr!("terminal", "continue-sharing"))
            .build()
            .with_cursor(Cursor::PointingHand)
            .on_click(move |ctx, _, _| {
...
impl View for InactivityModalBody {
    ...
    fn render(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        let header = Container::new(
            Text::new_inline(
                crate::tr!("terminal", "are-you-still-there"),
