...
impl TerminalView {
    pub(super) fn ai_block_copying_menu_items(
        ...
        let mut items = vec![
            MenuItemFields::new(crate::tr!("terminal", "ctx-copy"))
                .with_on_select_action(TerminalAction::ContextMenu(
                    ContextMenuAction::CopyAIBlock { ai_block_view_id },
                ))
                .into_item(),
            MenuItemFields::new(crate::tr!("terminal", "ctx-copy-prompt"))
                .with_on_select_action(TerminalAction::ContextMenu(
                    ContextMenuAction::CopyAIBlockQuery { ai_block_view_id },
                ))
                .into_item(),
            MenuItemFields::new(crate::tr!("terminal", "ctx-copy-output-as-markdown"))
                .with_on_select_action(TerminalAction::ContextMenu(
        ...
        if let Some(link) = hovered_link {
            match link {
                RichContentLink::Url(url) => {
                    items.push(
                        MenuItemFields::new(crate::tr!("terminal", "ctx-copy-url"))
                            .with_on_select_action(TerminalAction::ContextMenu(
                ...
                RichContentLink::FilePath { absolute_path, .. } => {
                    items.push(
                        MenuItemFields::new(crate::tr!("terminal", "ctx-copy-path"))
                            .with_on_select_action(TerminalAction::ContextMenu(
        ...
        if num_requested_commands > 0 {
            items.push(
                MenuItemFields::new(crate::tr!("terminal", "ctx-copy-command"))
                    .with_on_select_action(TerminalAction::ContextMenu(
        ...
        if has_git_branch {
            items.push(
                MenuItemFields::new(crate::tr!("terminal", "ctx-copy-git-branch"))
                    .with_on_select_action(TerminalAction::ContextMenu(
        ...
        items.push(
            MenuItemFields::new(crate::tr!("terminal", "ctx-save-as-prompt"))
                .with_on_select_action(TerminalAction::ContextMenu(
        ...
        if FeatureFlag::CloudConversations.is_enabled() {
            ...
            if history_model.can_conversation_be_shared(&ai_conversation_id) {
                items.push(
                    MenuItemFields::new(crate::tr!("terminal", "ctx-copy-share-link"))
                        .with_on_select_action(TerminalAction::ContextMenu(
                ...
                items.push(
                    MenuItemFields::new(crate::tr!("terminal", "ctx-share-conversation"))
                        .with_on_select_action(TerminalAction::ContextMenu(
        ...
        items.push(
            MenuItemFields::new(crate::tr!("terminal", "ctx-copy-conversation-text"))
                .with_on_select_action(TerminalAction::ContextMenu(
    ...
    fn copy_debugging_menu_items(
        ...
        if ChannelState::channel().is_dogfood() {
            vec![
                (
                    crate::tr!("terminal", "ctx-copy-debugging-link"),
                ...
                (
                    crate::tr!("terminal", "ctx-copy-conversation-id"),
            ...
            vec![(
                crate::tr!("terminal", "ctx-copy-debugging-id"),
    ...
    fn conversation_menu_items(
        ...
        items.push(
            MenuItemFields::new(crate::tr!("terminal", "ctx-fork"))
                .with_on_select_action(TerminalAction::ContextMenu(
    ...
    pub(super) fn open_ai_block_overflow_context_menu(
        ...
        if !cfg!(target_family = "wasm") {
            ...
            if ChannelState::channel().is_dogfood() {
                menu_items.push(
                    MenuItemFields::new(crate::tr!("terminal", "ctx-fork-from-here"))
                        .with_on_select_action(TerminalAction::ContextMenu(
        ...
        if FeatureFlag::RevertToCheckpoints.is_enabled() && !is_restored {
            menu_items.push(
                MenuItemFields::new(crate::tr!("terminal", "ctx-rewind-to-before-here"))
