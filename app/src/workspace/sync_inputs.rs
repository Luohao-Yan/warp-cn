...
pub fn init(app: &mut AppContext) {
    ...
    app.register_editable_bindings(vec![
        EditableBinding::new(
            ...
            crate::tr!("workspace", "stop-synchronizing-any-panes"),
        ...
        EditableBinding::new(
            ...
            crate::tr!("workspace", "toggle-synchronizing-all-panes-in-current-tab"),
        ...
        EditableBinding::new(
            ...
            crate::tr!("workspace", "toggle-synchronizing-all-panes-in-all-tabs"),
