...
impl View for CloseSessionConfirmationDialog {
    ...
    fn render(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        let dont_show_again_checkbox = appearance
            ...
            .with_label(Span::new(crate::tr!("common", "do-not-show-again").clone(), Default::default()))
        ...
        let close_session_button = appearance
            ...
            .with_centered_text_label(crate::tr!("workspace", "close-session-title").into())
        ...
        let cancel_button = appearance
            ...
            .with_centered_text_label(crate::tr!("common", "cancel-label").into())
            .with_style(button_style)
            .build()
            .with_cursor(Cursor::PointingHand)
            .on_click(move |ctx, _, _| {
        ...
        let dialog = Container::new(
            Dialog::new(
                crate::tr!("workspace", "close-session-question").into(),
                Some(
                    crate::tr!("workspace", "close-session-sharing-warning")
                        .into(),
                ),
                UiComponentStyles {
                    width: Some(460.),
