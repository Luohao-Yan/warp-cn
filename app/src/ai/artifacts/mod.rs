    ...
    fn from(file: api::message::artifact_event::FileArtifact) -> Self {
        Artifact::File {
            ...
            filename: Path::new(&file.filepath)
                ...
                .unwrap_or(&crate::tr!("ai_assistant", "ai-file-type-label"))
                .to_string(),
...
pub fn file_button_label(filename: &str, filepath: &str) -> String {
    ...
    crate::tr!("ai_assistant", "ai-file-type-label").to_string()
}
...
fn screenshot_lightbox_image_from_download_result(
    ...
    match result {
        ...
        Err(e) => {
            ...
            Some(LightboxImage {
                source: LightboxImageSource::Loading,
                description: Some(crate::tr!("ai_assistant", "ai-artifact-failed-load").to_string()),
            })
        }
    }
}
...
fn download_toast_filename(path: &Path) -> String {
    path.file_name()
        ...
        .unwrap_or(&crate::tr!("ai_assistant", "ai-file-fallback-name"))
        .to_string()
}
