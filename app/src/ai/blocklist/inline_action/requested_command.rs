...
impl RequestedCommandView {
    ...
    pub fn new(
        ...
        let reject_label = crate::tr!("ai_assistant", "ai-reject");
        ...
        let run_label = crate::tr!("ai_assistant", "ai-run");
        ...
        let edit_label = crate::tr!("ai_assistant", "ai-edit-command");
        ...
        let done_label = crate::tr!("ai_assistant", "ai-done");
    ...
    fn toggle_accept_split_button_menu(&mut self, ctx: &mut ViewContext<Self>) {
        ...
        if self.is_accept_split_button_menu_open {
            ...
            let auto_item = MenuItemFields::new_with_label(crate::tr!("ai_assistant", "ai-auto-approve"), auto_keystroke)
            ...
            (
                ...
                *shown.lock() = true;
                Some(render_autonomy_checkbox_setting_speedbump_footer(
                    crate::tr!("ai_assistant", "ai-autoexecute-readonly-speedbump"),
                    *checked,
