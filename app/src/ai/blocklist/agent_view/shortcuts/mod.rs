...
pub fn render_agent_shortcuts_view(
    ...
    if !hide_cloud_zero_state_items {
        shortcuts.push(render_shortcut(
            ShortcutProps {
                ...
                text: crate::tr!("ai_assistant", "ai-shortcut-input-shell").into(),
                ..Default::default()
            },
            app,
        ));
    ...
    shortcuts.push(render_shortcut(
        ShortcutProps {
            ...
            text: crate::tr!("ai_assistant", "ai-shortcut-for-slash-commands").into(),
            ..Default::default()
        },
        app,
    ));
    ...
    shortcuts.push(render_shortcut(
        ShortcutProps {
            ...
            text: crate::tr!("ai_assistant", "ai-shortcut-for-file-paths").into(),
            ..Default::default()
        },
        app,
    ));
    ...
    if !context.is_cloud_agent {
        if let Some(keystroke) = keybinding_name_to_keystroke(TOGGLE_RIGHT_PANEL_BINDING_NAME, app)
        {
            shortcuts.push(render_shortcut(
                ShortcutProps {
                    keystroke,
                    text: crate::tr!("ai_assistant", "ai-shortcut-open-code-review").into(),
                    ..Default::default()
                },
                app,
            ));
    ...
    if FeatureFlag::AgentViewConversationListView.is_enabled() {
            ...
            keybinding_name_to_keystroke(TOGGLE_CONVERSATION_LIST_VIEW_BINDING_NAME, app)
        {
            shortcuts.push(render_shortcut(
                ShortcutProps {
                    keystroke,
                    text: crate::tr!("ai_assistant", "ai-shortcut-toggle-conversation-list").into(),
                    ..Default::default()
                },
                app,
            ));
    ...
    shortcuts.push(render_shortcut(
        ShortcutProps {
            ...
            text: crate::tr!("ai_assistant", "ai-shortcut-search-conversations").into(),
            ..Default::default()
        },
        app,
    ));
    ...
    shortcuts.push(render_shortcut(
        ShortcutProps {
            ...
            text: crate::tr!("ai_assistant", "ai-shortcut-start-new-conversation").into(),
            ..Default::default()
        },
        app,
    ));
    ...
    if !hide_cloud_zero_state_items {
            ...
            keybinding_name_to_keystroke(TOGGLE_AUTOEXECUTE_MODE_KEYBINDING, app)
        {
            shortcuts.push(render_shortcut(
                ShortcutProps {
                    keystroke,
                    text: crate::tr!("ai_assistant", "ai-shortcut-toggle-auto-accept").into(),
                    ..Default::default()
                },
                app,
            ));
    ...
    shortcuts.push(render_shortcut(
        ShortcutProps {
            ...
            text: crate::tr!("ai_assistant", "ai-shortcut-pause-agent").into(),
            ..Default::default()
        },
        app,
    ));
    ...
    shortcuts.push(render_shortcut(
        ShortcutProps {
            ...
            text: crate::tr!("ai_assistant", "ai-esc-go-back-to-terminal").into(),
            ..Default::default()
        },
        app,
    ));
