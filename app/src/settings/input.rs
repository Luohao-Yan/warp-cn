...
define_settings_group!(InputSettings,
    settings: [
        show_hint_text: ShowHintText {
            ...
            description: "Whether hint text is shown in the terminal input.".to_string(),
        },
        classic_completions_mode: ClassicCompletionsMode {
            ...
            description: "Whether classic completions mode is enabled.".to_string(),
        },
        completions_open_while_typing: CompletionsOpenWhileTyping {
            ...
            description: "Whether the completions menu opens automatically while typing.".to_string(),
        },
        error_underlining: ErrorUnderliningEnabled {
            ...
            description: "Whether command errors are underlined in the input.".to_string(),
        },
        syntax_highlighting: SyntaxHighlighting {
            ...
            description: "Whether syntax highlighting is enabled in the terminal input.".to_string(),
        },
        command_corrections: CommandCorrections {
            ...
            description: "Whether command corrections are suggested for mistyped commands.".to_string(),
        },
        ...
        input_box_type: InputBoxTypeSetting {
            ...
            description: "The terminal input style.".to_string(),
        },
        at_context_menu_in_terminal_mode: AtContextMenuInTerminalMode {
            ...
            description: "Whether the @ context menu is available in terminal mode.".to_string(),
        },
        enable_slash_commands_in_terminal: EnableSlashCommandsInTerminal {
            ...
            description: "Whether slash commands are available in the terminal input.".to_string(),
        },
        outline_codebase_symbols_for_at_context_menu: OutlineCodebaseSymbolsForAtContextMenu {
            ...
            description: "Whether codebase symbols appear in the @ context menu.".to_string(),
        },
        ...
        show_agent_tips: ShowAgentTips {
            ...
            description: "Whether agent tips are displayed in the input.".to_string(),
        },
        ...
        show_terminal_input_message_bar: ShowTerminalInputMessageBar {
            ...
            description: "Whether the terminal input message bar is shown.".to_string(),
        },
