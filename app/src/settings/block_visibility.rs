...
define_settings_group!(BlockVisibilitySettings, settings: [
   should_show_bootstrap_block: ShouldShowBootstrapBlock {
       ...
       description: "Whether the bootstrap block is visible in the terminal.".to_string(),
   },
   should_show_in_band_command_blocks: ShouldShowInBandCommandBlocks {
       ...
       description: "Whether in-band command blocks are visible in the terminal.".to_string(),
   },
   should_show_ssh_block: ShouldShowSSHBlock {
        ...
        description: "Whether the SSH connection block is visible in the terminal.".to_string(),
   }
]);
