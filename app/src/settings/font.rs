...
define_settings_group!(FontSettings,
    settings: [
        monospace_font_name: MonospaceFontName {
            ...
            description: "The monospace font used in the terminal.".to_string(),
        },
        monospace_font_size: MonospaceFontSize {
            ...
            description: "The size of the monospace font in the terminal.".to_string(),
        },
        monospace_font_weight: MonospaceFontWeight {
            ...
            description: "The weight of the monospace font in the terminal.".to_string(),
        },
        line_height_ratio: LineHeightRatio {
            ...
            description: "The line height ratio for terminal text.".to_string(),
        },
        ai_font_name: AIFontName {
            ...
            description: "The font used for AI-generated content.".to_string(),
        },
        match_ai_font_to_terminal_font: MatchAIFontToTerminalFont {
            ...
            description: "Whether the AI font automatically matches the terminal font.".to_string(),
        },
        notebook_font_size: NotebookFontSize {
            ...
            description: "The font size used in notebooks.".to_string(),
        },
        match_notebook_to_monospace_font_size: MatchNotebookToMonospaceFontSize {
            ...
            description: "Whether the notebook font size matches the terminal font size.".to_string(),
        },
        enforce_minimum_contrast: EnforceMinimumContrast {
            ...
            description: "Whether to enforce minimum contrast for text readability.".to_string(),
        },
        use_thin_strokes: UseThinStrokes {
            ...
            description: "Whether to use thin font strokes on macOS.".to_string(),
        },
    ]
);
