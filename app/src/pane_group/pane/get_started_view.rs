...
impl GetStartedView {
    pub fn new(ctx: &mut ViewContext<Self>) -> Self {
        let pane_configuration = ctx.add_model(|_ctx| PaneConfiguration::new(&crate::tr!("pane_group", "pane-get-started-title")));
    ...
    fn render_main_content(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        Flex::column()
            ...
            .with_children([
                ...
                appearance
                    .ui_builder()
                    .paragraph(crate::tr!("workspace", "welcome-to-warp"))
                ...
                Container::new(
                    appearance
                        .ui_builder()
                        .paragraph(crate::tr!("workspace", "agentic-dev-env"))
                        .with_style(UiComponentStyles {
                            font_size: Some(14.),
...
impl BackingView for GetStartedView {
    ...
    fn render_header_content(
        ...
        view::HeaderContent::simple(&crate::tr!("pane_group", "pane-get-started-title"))
    }
