...
impl Display for IPaneType {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            IPaneType::Terminal => write!(f, "{}", crate::tr!("workspace", "workspace-terminal")),
            IPaneType::Notebook => write!(f, "{}", crate::tr!("workspace", "workspace-notebook")),
            IPaneType::File => write!(f, "{}", crate::tr!("workspace", "workspace-file")),
            IPaneType::Code => write!(f, "{}", crate::tr!("workspace", "workspace-code")),
            IPaneType::CodeDiff => write!(f, "{}", crate::tr!("workspace", "workspace-pane-code-diff")),
            IPaneType::EnvVarCollection => write!(f, "{}", crate::tr!("workspace", "workspace-pane-env-vars")),
            IPaneType::EnvironmentManagement => write!(f, "{}", crate::tr!("workspace", "workspace-environments")),
            IPaneType::Workflow => write!(f, "{}", crate::tr!("workspace", "workspace-workflow")),
            IPaneType::Settings => write!(f, "{}", crate::tr!("workspace", "workspace-pane-settings")),
            IPaneType::AIFact => write!(f, "{}", crate::tr!("workspace", "workspace-pane-ai-fact")),
            IPaneType::AIDocument => write!(f, "{}", crate::tr!("workspace", "workspace-pane-ai-document")),
            IPaneType::ExecutionProfileEditor => write!(f, "{}", crate::tr!("workspace", "workspace-pane-execution-profile")),
            IPaneType::GetStarted => write!(f, "GetStarted"),
            IPaneType::NetworkLog => write!(f, "{}", crate::tr!("workspace", "workspace-network-log-header")),
            IPaneType::Welcome => write!(f, "{}", crate::tr!("workspace", "workspace-welcome-to-warp")),
            IPaneType::DeferredPlaceholder => write!(f, "{}", crate::tr!("workspace", "workspace-placeholder")),
            #[cfg(test)]
