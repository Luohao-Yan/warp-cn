...
impl Display for IPaneType {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            IPaneType::Terminal => write!(f, "{}", crate::tr!("workspace", "terminal")),
            IPaneType::Notebook => write!(f, "{}", crate::tr!("workspace", "notebook")),
            IPaneType::File => write!(f, "{}", crate::tr!("workspace", "file")),
            IPaneType::Code => write!(f, "{}", crate::tr!("workspace", "code")),
            IPaneType::CodeDiff => write!(f, "{}", crate::tr!("workspace", "pane-code-diff")),
            IPaneType::EnvVarCollection => write!(f, "{}", crate::tr!("workspace", "pane-env-vars")),
            IPaneType::EnvironmentManagement => write!(f, "{}", crate::tr!("workspace", "environments")),
            IPaneType::Workflow => write!(f, "{}", crate::tr!("workspace", "workflow")),
            IPaneType::Settings => write!(f, "{}", crate::tr!("workspace", "pane-settings")),
