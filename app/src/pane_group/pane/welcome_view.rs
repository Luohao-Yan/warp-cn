...
impl WelcomeView {
    pub fn new(startup_directory: Option<PathBuf>, ctx: &mut ViewContext<Self>) -> Self {
        let pane_configuration = ctx.add_model(|_ctx| PaneConfiguration::new(&crate::tr!("pane_group", "pane-new-tab-title")));
...
impl BackingView for WelcomeView {
    ...
    fn render_header_content(
        ...
        view::HeaderContent::simple(&crate::tr!("pane_group", "pane-new-tab-title"))
    }
