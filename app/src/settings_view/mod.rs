...
impl Display for SettingsSection {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            SettingsSection::Appearance => f.write_str(&crate::tr!("settings", "appearance-tab")),
            SettingsSection::Features => f.write_str(&crate::tr!("settings", "features-tab")),
            SettingsSection::AI => f.write_str(&crate::tr!("settings", "ai-tab")),
            SettingsSection::Code => f.write_str(&crate::tr!("settings", "code-tab")),
            SettingsSection::Keybindings => f.write_str(&crate::tr!("settings", "keybindings-tab")),
            SettingsSection::Privacy => f.write_str(&crate::tr!("settings", "privacy-tab")),
            SettingsSection::About => f.write_str(&crate::tr!("settings", "about-tab")),
            SettingsSection::Account => f.write_str(&crate::tr!("settings", "account-tab")),
            SettingsSection::Teams => f.write_str(&crate::tr!("settings", "teams-tab")),
            SettingsSection::Referrals => f.write_str(&crate::tr!("settings", "referrals-tab")),
            SettingsSection::WarpDrive => f.write_str(&crate::tr!("settings", "warp-drive-tab")),
            SettingsSection::WarpAgent => f.write_str(&crate::tr!("settings", "warp-agent-tab")),
            SettingsSection::AgentProfiles => f.write_str(&crate::tr!("settings", "profiles-tab")),
            SettingsSection::MCPServers => f.write_str(&crate::tr!("settings", "mcp-servers-tab")),
            SettingsSection::BillingAndUsage => f.write_str(&crate::tr!("settings", "billing-tab")),
            SettingsSection::SharedBlocks => f.write_str(&crate::tr!("settings", "shared-blocks-tab")),
            SettingsSection::Warpify => f.write_str(&crate::tr!("settings", "warpify-tab")),
            SettingsSection::CloudEnvironments => f.write_str(&crate::tr!("settings", "environments-tab")),
            SettingsSection::AgentMCPServers => f.write_str(&crate::tr!("settings", "mcp-servers-tab")),
            SettingsSection::Knowledge => f.write_str(&crate::tr!("settings", "knowledge-tab")),
            SettingsSection::ThirdPartyCLIAgents => f.write_str(&crate::tr!("settings", "third-party-cli-agents")),
