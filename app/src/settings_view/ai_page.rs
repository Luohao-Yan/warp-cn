...
static_tr!(NEXT_COMMAND_DESC, "settings", "ai-next-command-description");
static_tr!(PROMPT_SUGGESTIONS_DESC, "settings", "ai-prompt-suggestions-desc");
static_tr!(SUGGESTED_CODE_BANNERS_DESC, "settings", "ai-suggested-code-banners-description");
static_tr!(NATURAL_LANGUAGE_AUTOSUGGESTIONS_DESC, "settings", "ai-nl-autosuggestions-desc");
static_tr!(SHARED_BLOCK_TITLE_GEN_DESC, "settings", "ai-shared-block-title-desc");
static_tr!(GIT_OPERATIONS_AUTOGEN_DESC, "settings", "ai-git-autogen-desc");
...
static_tr!(ADD_PROFILE_LABEL, "settings", "add-profile");
static_tr!(REFRESH_LABEL, "settings", "refresh");
static_tr!(AI_THINKING_DISPLAY_DESC, "settings", "ai-thinking-display-desc");
...
pub fn init_actions_from_parent_view<T: Action + Clone>(
    ...
    ToggleSettingActionPair::add_toggle_setting_action_pairs_as_bindings(
        vec![ToggleSettingActionPair::new(
            crate::tr!("settings", "ai-cmd-global-ai"),
    ...
    ToggleSettingActionPair::add_toggle_setting_action_pairs_as_bindings(
        vec![ToggleSettingActionPair::new(
            if FeatureFlag::AgentView.is_enabled() {
                crate::tr!("settings", "ai-cmd-term-cmd-autodetection-agent-input")
            } else {
                crate::tr!("settings", "ai-cmd-nl-detection")
            },
    ...
    ToggleSettingActionPair::add_toggle_setting_action_pairs_as_bindings(
        vec![ToggleSettingActionPair::new(
            crate::tr!("settings", "ai-cmd-agent-prompt-autodetection-terminal"),
            builder(SettingsAction::AI(
    ...
    ToggleSettingActionPair::add_toggle_setting_action_pairs_as_bindings(
        vec![ToggleSettingActionPair::new(
            crate::tr!("settings", "ai-cmd-next-command"),
            builder(SettingsAction::AI(
    ...
    ToggleSettingActionPair::add_toggle_setting_action_pairs_as_bindings(
        vec![ToggleSettingActionPair::new(
            crate::tr!("settings", "ai-cmd-prompt-suggestions"),
            builder(SettingsAction::AI(
    ...
    ToggleSettingActionPair::add_toggle_setting_action_pairs_as_bindings(
        vec![ToggleSettingActionPair::new(
            crate::tr!("settings", "ai-cmd-code-suggestions"),
            builder(SettingsAction::AI(
    ...
    ToggleSettingActionPair::add_toggle_setting_action_pairs_as_bindings(
        vec![ToggleSettingActionPair::custom(
            SettingActionPairDescriptions::new(
                crate::tr!("settings", "ai-cmd-show-agent-tips"),
                crate::tr!("settings", "ai-cmd-hide-agent-tips"),
            ),
            builder(SettingsAction::AI(
    ...
    ToggleSettingActionPair::add_toggle_setting_action_pairs_as_bindings(
        vec![ToggleSettingActionPair::custom(
            SettingActionPairDescriptions::new(
                crate::tr!("settings", "ai-cmd-show-oz-changelog-agent-view"),
                crate::tr!("settings", "ai-cmd-hide-oz-changelog-agent-view"),
            ),
            builder(SettingsAction::AI(
    ...
    ToggleSettingActionPair::add_toggle_setting_action_pairs_as_bindings(
        vec![ToggleSettingActionPair::new(
            crate::tr!("settings", "ai-cmd-nl-autosuggestions"),
            builder(SettingsAction::AI(
    ...
    ToggleSettingActionPair::add_toggle_setting_action_pairs_as_bindings(
        vec![ToggleSettingActionPair::new(
            crate::tr!("settings", "ai-cmd-shared-block-title-gen"),
            builder(SettingsAction::AI(
    ...
    ToggleSettingActionPair::add_toggle_setting_action_pairs_as_bindings(
        vec![ToggleSettingActionPair::new(
            crate::tr!("settings", "ai-cmd-commit-pr-gen"),
            builder(SettingsAction::AI(
    ...
    ToggleSettingActionPair::add_toggle_setting_action_pairs_as_bindings(
        vec![ToggleSettingActionPair::new(
            crate::tr!("settings", "ai-cmd-voice-input"),
    ...
    ToggleSettingActionPair::add_toggle_setting_action_pairs_as_bindings(
        vec![ToggleSettingActionPair::custom(
            SettingActionPairDescriptions::new(
                crate::tr!("settings", "ai-cmd-show-use-agent-footer"),
                crate::tr!("settings", "ai-cmd-hide-use-agent-footer"),
            ),
            builder(SettingsAction::AI(
    ...
    ToggleSettingActionPair::add_toggle_setting_action_pairs_as_bindings(
        vec![
            ToggleSettingActionPair::new(
                crate::tr!("settings", "ai-cmd-include-agent-cmds-history"),
                builder(SettingsAction::AI(
            ...
            .with_group(bindings::BindingGroup::WarpAi),
            ToggleSettingActionPair::new(
                crate::tr!("settings", "ai-cmd-conversation-history-tools"),
                builder(SettingsAction::AI(
            ...
            .with_group(bindings::BindingGroup::WarpAi),
            ToggleSettingActionPair::new(
                crate::tr!("settings", "ai-cmd-model-picker-prompt"),
                builder(SettingsAction::AI(
            ...
            .with_group(bindings::BindingGroup::WarpAi),
            ToggleSettingActionPair::new(
                crate::tr!("settings", "ai-cmd-coding-agent-toolbar"),
                builder(SettingsAction::AI(
    ...
    ToggleSettingActionPair::add_toggle_setting_action_pairs_as_bindings(
        vec![
            ToggleSettingActionPair::new(
                crate::tr!("settings", "ai-cmd-rules"),
            ...
            ToggleSettingActionPair::new(
                crate::tr!("settings", "ai-cmd-suggested-rules"),
                builder(SettingsAction::AI(
            ...
            ToggleSettingActionPair::new(
                crate::tr!("settings", "ai-cmd-warp-drive-context"),
                builder(SettingsAction::AI(
            ...
            .with_enabled(|| FeatureFlag::AIRules.is_enabled()),
            ToggleSettingActionPair::new(
                crate::tr!("settings", "ai-cmd-auto-spawn-servers"),
    ...
    ToggleSettingActionPair::add_toggle_setting_action_pairs_as_bindings(
        vec![
            ToggleSettingActionPair::new(
                crate::tr!("settings", "ai-cmd-warp-credit-fallback"),
                builder(SettingsAction::AI(
            ...
            ToggleSettingActionPair::new(
                crate::tr!("settings", "ai-cmd-auto-toggle-rich-input"),
                builder(SettingsAction::AI(
            ...
            ToggleSettingActionPair::new(
                crate::tr!("settings", "ai-cmd-auto-open-rich-input"),
                builder(SettingsAction::AI(
            ...
            .with_enabled(|| FeatureFlag::CLIAgentRichInput.is_enabled()),
            ToggleSettingActionPair::new(
                crate::tr!("settings", "ai-cmd-auto-dismiss-rich-input"),
                builder(SettingsAction::AI(
    ...
    if !FeatureFlag::FullSourceCodeEmbedding.is_enabled() {
        ToggleSettingActionPair::add_toggle_setting_action_pairs_as_bindings(
            vec![ToggleSettingActionPair::new(
                crate::tr!("settings", "ai-cmd-codebase-index"),
                builder(SettingsAction::AI(
...
impl AISettingsPageView {
    pub fn new(ctx: &mut ViewContext<Self>) -> Self {
        ...
        let code_read_allowlist_editor = ctx.add_typed_action_view(|ctx| {
            ...
            input.set_placeholder_text(&crate::tr!("settings", "settings-ai-dir-allowlist-placeholder"), ctx);
            input
        });
        Self::update_editor_interaction_state(
        ...
        let autodetection_denylist_editor = ctx.add_typed_action_view(|ctx| {
            ...
            editor.set_placeholder_text(&crate::tr!("settings", "ai-commands-placeholder"), ctx);
        ...
        let command_execution_allowlist_editor = ctx.add_typed_action_view(|ctx| {
            ...
            input.set_placeholder_text(&crate::tr!("settings", "settings-ai-cmd-allowlist-placeholder"), ctx);
            input
        });
        Self::update_editor_interaction_state(
        ...
        let command_execution_denylist_editor = ctx.add_typed_action_view(|ctx| {
            let mut input =
                SubmittableTextInput::new(ctx).validate_on_edit(|s| Regex::new(s).is_ok());
            input.set_placeholder_text(&crate::tr!("settings", "settings-ai-cmd-denylist-placeholder"), ctx);
            input
        });
        Self::update_editor_interaction_state(
        ...
        let cli_agent_footer_command_editor = ctx.add_typed_action_view(|ctx| {
            let mut input =
                SubmittableTextInput::new(ctx).validate_on_edit(|s| Regex::new(s).is_ok());
            input.set_placeholder_text(&crate::tr!("settings", "settings-ai-cli-agent-cmd-placeholder"), ctx);
            input
        });
        ...
        let apply_code_diffs_dropdown_menu = ctx.add_typed_action_view(|ctx| {
            ...
            dropdown.set_items(
                vec![
                    DropdownItem::new(
                        crate::tr!("settings", "ai-agent-decides"),
        ...
        let write_to_pty_autonomy_dropdown_menu = ctx.add_typed_action_view(|ctx| {
            ...
            dropdown.set_items(
                vec![
                    ...
                    DropdownItem::new(
                        crate::tr!("settings", "ai-ask-on-first-write"),
        ...
        let mcp_allowlist_dropdown = ctx.add_typed_action_view(|ctx| {
            ...
            dropdown.set_top_bar_max_width(AI_SETTINGS_DROPDOWN_WIDTH);
            dropdown.set_menu_width(AI_SETTINGS_DROPDOWN_WIDTH, ctx);
            dropdown.set_menu_header_to_static(crate::tr!("settings", "ai-select-mcp-servers").leak());
            dropdown
        });
        ...
        let add_profile_button = ctx.add_typed_action_view(|_| {
            ActionButton::new(ADD_PROFILE_LABEL.get(), SecondaryTheme)
                .with_icon(Icon::Plus)
        ...
        let custom_inference_add_button = ctx.add_typed_action_view(|_| {
            ActionButton::new(crate::tr!("settings", "ai-add-custom-model"), SecondaryTheme)
                .with_size(ButtonSize::Small)
                .on_click(|ctx| {
        ...
        let custom_endpoint_modal_view = ctx.add_typed_action_view(|ctx| {
            Modal::new(
                Some(crate::tr!("settings", "ai-add-custom-endpoint").to_string()),
        ...
        let conversation_layout_dropdown = ctx.add_typed_action_view(|ctx| {
            ...
            match current {
                OpenConversationPreference::NewTab => dropdown.set_selected_by_name(crate::tr!("settings", "ai-new-tab"), ctx),
                OpenConversationPreference::SplitPane => {
                    dropdown.set_selected_by_name(crate::tr!("settings", "ai-split-pane"), ctx)
                }
            };
            dropdown
        });
    ...
    fn show_add_custom_endpoint_modal(&mut self, ctx: &mut ViewContext<Self>) {
        ...
        self.custom_endpoint_modal_state
            .set_title(Some(crate::tr!("settings", "ai-add-custom-endpoint").to_string()), ctx);
    ...
    fn show_edit_custom_endpoint_modal(&mut self, index: usize, ctx: &mut ViewContext<Self>) {
        ...
        self.custom_endpoint_modal_state
            .set_title(Some(crate::tr!("settings", "ai-edit-custom-endpoint").to_string()), ctx);
        self.custom_endpoint_modal_state
    ...
    fn create_grok_code_editor(ctx: &mut ViewContext<Self>) -> ViewHandle<EditorView> {
        ctx.add_typed_action_view(|ctx| {
            ...
            let mut editor = EditorView::single_line(options, ctx);
            editor.set_placeholder_text(&crate::tr!("settings", "ai-paste-sign-in-code"), ctx);
            editor
        })
    }
    ...
    fn start_grok_oauth(&mut self, ctx: &mut ViewContext<Self>) {
        ...
        let attempt = match oauth::OauthAttempt::start() {
            ...
            Err(err) => {
                ...
                ToastStack::handle(ctx).update(ctx, |toast_stack, ctx| {
                    let toast =
                        DismissibleToast::error(crate::tr!("settings", "settings-ai-grok-login-error", err = err.to_string()));
                    toast_stack.add_ephemeral_toast(toast, window_id, ctx);
                });
                return;
            }
        ...
        ToastStack::handle(ctx).update(ctx, |toast_stack, ctx| {
            ...
            let toast = DismissibleToast::default(
                crate::tr!("settings", "ai-opening-browser-supergrok"),
            )
            .with_object_id(CONNECT_TOAST_OBJECT_ID.to_string())
            .with_link(
                ToastLink::new(crate::tr!("settings", "settings-ai-grok-copy-url-link"))
        ...
        ctx.spawn(async move { attempt.finish().await }, |me, result, ctx| {
            ...
            let toast = match result {
                Ok(tokens) => {
                    ...
                    DismissibleToast::success(crate::tr!("settings", "settings-ai-grok-connected-toast"))
                }
                Err(err) => {
                    me.grok_oauth_attempt = None;
                    me.grok_code_editor.update(ctx, |editor, ctx| {
                    ...
                    DismissibleToast::error(crate::tr!("settings", "settings-ai-grok-connect-error", err = format!("{err:#}")))
                }
            };
            ToastStack::handle(ctx).update(ctx, |toast_stack, ctx| {
        ...
        menu.update(ctx, |menu, ctx| {
            ...
            menu.set_items(
                AgentModeCodingPermissionsType::iter()
                    .map(|t| {
                        let display = match t {
                            AgentModeCodingPermissionsType::AlwaysAskBeforeReading => crate::tr!("settings", "ai-always-ask"),
                            AgentModeCodingPermissionsType::AlwaysAllowReading => crate::tr!("settings", "ai-always-allow"),
                            AgentModeCodingPermissionsType::AllowReadingSpecificFiles => {
                                crate::tr!("settings", "ai-allow-specific-directories")
                            }
                        };
        ...
        entries
            ...
            .map(|(pattern_clone, current_agent)| {
                ctx.add_typed_action_view(move |ctx| {
                    ...
                    items.push(
                        MenuItemFields::new(crate::tr!("settings", "ai-other-agent"))
                            .with_on_select_action(DropdownAction::select_action_and_close(
                                AISettingsPageAction::SetCLIAgentForCommand {
                                    pattern: pattern_clone.clone(),
                                    agent: None,
                    ...
                    let other_label = crate::tr!("settings", "ai-other-agent");
                    dropdown.set_menu_header_text_override(move |label| {
                        if label == other_label {
                            crate::tr!("settings", "ai-select-coding-agent")
                        } else {
                            label.to_string()
                        }
                    });
                    ...
                    let selected_name = if matches!(current_agent, CLIAgent::Unknown) {
                        crate::tr!("settings", "ai-other-agent")
                    } else {
...
impl From<&AISettingsPageAction> for LoginGatedFeature {
    fn from(val: &AISettingsPageAction) -> LoginGatedFeature {
        ...
        static_tr!(UPGRADE_AI, "settings", "ai-upgrade-ai-usage");
        static_tr!(UNKNOWN_REASON, "settings", "ai-unknown-reason");
        match val {
            AttemptLoginGatedUpgrade => UPGRADE_AI.get(),
            _ => UNKNOWN_REASON.get(),
        }
    }
}
            ...
            AISettingsPageAction::DisconnectGrokSubscription => {
                ...
                crate::ToastStack::handle(ctx).update(ctx, |toast_stack, ctx| {
                    let toast = crate::view_components::DismissibleToast::default(
                        crate::tr!("settings", "ai-supergrok-disconnected"),
                    );
                    toast_stack.add_ephemeral_toast(toast, window_id, ctx);
                });
                ctx.notify();
...
fn render_toolbar_layout_editor(
    ...
    let label = Container::new(
        appearance
            .ui_builder()
            .span(crate::tr!("settings", "ai-toolbar-layout-label").to_string())
            .with_style(UiComponentStyles {
...
impl SettingsWidget for GlobalAIWidget {
    ...
    fn render(
        ...
        let mut row = Flex::row()
            ...
            .with_child(
                Text::new_inline(
                    crate::tr!("settings", "warp-agent-tab"),
        ...
        if is_ai_disabled_due_to_remote_session_org_policy {
            row.add_child(
                ConstrainedBox::new(
                    Container::new(
                        Text::new(crate::tr!("settings", "ai-org-disallow-remote-session"), appearance.ui_font_family(), 12.)
            ...
            row.add_child(
                Flex::row()
                    ...
                    .with_child(
                        Container::new(
                            Text::new_inline(
                                crate::tr!("settings", "ai-create-account-prompt"),
                                appearance.ui_font_family(),
                                14.,
                            )
                            .with_color(
                    ...
                    .with_child(
                        Container::new(
                            ui_builder
                                ...
                                .with_text_label(crate::tr!("settings", "sign-up").to_owned())
                                .build()
                                .on_click(move |ctx, _, _| {
                                    ctx.dispatch_typed_action(
                                        AISettingsPageAction::SignupAnonymousUser,
...
impl UsageWidget {
    fn render_request_usage_count(
        ...
        let request_count_label = if workspace_is_delinquent_due_to_payment_issue {
            crate::tr!("settings", "ai-billing-restricted")
...
impl SettingsWidget for UsageWidget {
    ...
    fn render(
        ...
        let usage_header = Container::new(
            Flex::row()
                ...
                .with_child(
                    build_sub_header(
                        appearance,
                        crate::tr!("settings", "ai-usage-header"),
                ...
                .with_child(
                    appearance
                        .ui_builder()
                        .paragraph(crate::tr!("settings", "ai-usage-resets", time = formatted_next_refresh_time.as_str()))
                        .with_style(UiComponentStyles {
        ...
        let request_limit_description = crate::tr!(
            "settings",
            "ai-credit-limit-desc",
            ...
            UserWorkspaces::as_ref(app).current_team()
        {
            ...
            if team.billing_metadata.can_upgrade_to_higher_tier_plan() {
                ...
                if has_admin_permissions {
                    vec![
                        FormattedTextFragment::hyperlink(crate::tr!("settings", "ai-upgrade-link"), upgrade_url),
                        FormattedTextFragment::plain_text(crate::tr!("settings", "ai-upgrade-more-usage")),
                    ]
                } else {
                    // The /upgrade page says to contact their administrator.
                    vec![
                        FormattedTextFragment::hyperlink(crate::tr!("settings", "ai-compare-plans-link"), upgrade_url),
                        FormattedTextFragment::plain_text(crate::tr!("settings", "ai-compare-plans-more-usage")),
                    ]
                }
            } else {
                vec![
                    FormattedTextFragment::hyperlink(crate::tr!("settings", "ai-contact-support-link"), "mailto:support@warp.dev"),
                    FormattedTextFragment::plain_text(crate::tr!("settings", "ai-contact-support-more-usage")),
                ]
            }
        } else {
...
impl ActiveAIWidget {
        ...
        Flex::column()
            .with_child(
                render_ai_setting_toggle::<IntelligentAutosuggestionsEnabled>(
                    crate::tr!("settings", "ai-next-command"),
                    AISettingsPageAction::ToggleIntelligentAutosuggestions,
    ...
    fn render_suggested_code_banners_section(
        ...
        Flex::column()
            ...
            .with_child(render_ai_setting_description(
                SUGGESTED_CODE_BANNERS_DESC.get(),
                is_toggleable,
                app,
            ))
            .finish()
    ...
    fn render_natural_language_autosuggestions_section(
        ...
        Flex::column()
            ...
            .with_child(render_ai_setting_description(
                NATURAL_LANGUAGE_AUTOSUGGESTIONS_DESC.get(),
                is_toggleable,
                app,
            ))
            .finish()
    ...
    fn render_shared_block_title_generation_section(
        ...
        Flex::column()
            ...
            .with_child(render_ai_setting_description(
                SHARED_BLOCK_TITLE_GEN_DESC.get(),
                is_toggleable,
                app,
            ))
            .finish()
    ...
    fn render_git_operations_autogen_section(
        ...
        Flex::column()
            ...
            .with_child(render_ai_setting_description(
                GIT_OPERATIONS_AUTOGEN_DESC.get(),
                is_toggleable,
                app,
            ))
            .finish()
    ...
    fn render(
        ...
        if FeatureFlag::ProfilesDesignRevamp.is_enabled() {
            ...
            agents_header.add_child(
                build_sub_header(
                    appearance,
                    crate::tr!("settings", "ai-agents-header"),
                    Some(styles::header_font_color(is_any_ai_enabled, app)),
                )
                .with_padding_bottom(HEADER_PADDING)
                .finish(),
            ...
            agents_header.add_child(render_ai_setting_description(
                crate::tr!("settings", "ai-agents-description"),
                ai_settings.is_any_ai_enabled(app),
                app,
            ));
...
impl AgentsWidget {
    fn render_profiles_section(
        ...
        let header_and_description = Flex::column()
            .with_child(
                build_sub_header(
                    appearance,
                    crate::tr!("settings", "settings-ai-profiles-header"),
                    Some(styles::header_font_color(is_any_ai_enabled, app)),
                )
                .finish(),
            )
    ...
    fn render_models_section(
        ...
        let model_subheader = Container::new(render_custom_size_header(
            appearance,
            crate::tr!("settings", "ai-models-header"),
            14.0,
            Some(styles::header_font_color(is_any_ai_enabled, app)),
        ))
    ...
    fn render_context_window_setting(
        ...
        let label = Container::new(render_body_item_label::<AISettingsPageAction>(
            crate::tr!("settings", "ai-context-window-label"),
            None,
            None,
    ...
    fn render_permissions_section(
        ...
        let permissions_subheader = Container::new(render_custom_size_header(
            appearance,
            crate::tr!("settings", "ai-permissions-header"),
            14.0,
            Some(styles::header_font_color(is_any_ai_enabled, app)),
        ))
        .with_margin_bottom(4.0)
        ...
        let code_diffs = self.render_execution_profile_dropdown(
            crate::tr!("settings", "ai-apply-code-diffs"),
            Icon::Code2,
        ...
        read_files_flex.add_child(self.render_execution_profile_dropdown(
            crate::tr!("settings", "ai-read-files"),
            Icon::Notebook,
        ...
        execute_commands_flex.add_child(self.render_execution_profile_dropdown(
            crate::tr!("settings", "ai-execute-commands"),
            Icon::Terminal,
        ...
        if UserWorkspaces::as_ref(app)
            ...
            .has_any_overrides()
        {
            let banner_text = crate::tr!("settings", "ai-workspace-permissions-override");
        ...
        let write_to_pty = self.render_execution_profile_dropdown(
            crate::tr!("settings", "ai-interact-running-commands"),
            Icon::Workflow,
    ...
    fn render_command_denylist(
        ...
        render_ai_list(
            crate::tr!("settings", "ai-command-denylist-label"),
            crate::tr!("settings", "ai-command-denylist-desc"),
            list,
            view,
            ai_settings,
            app,
    ...
    fn render_command_allowlist(
        ...
        render_ai_list(
            crate::tr!("settings", "ai-command-allowlist-label"),
            crate::tr!("settings", "ai-command-allowlist-desc"),
            list,
            view,
            ai_settings,
            app,
    ...
    fn render_directory_allowlist(
        ...
        render_ai_list(
            crate::tr!("settings", "ai-directory-allowlist-label"),
            crate::tr!("settings", "ai-directory-allowlist-desc"),
            list,
            view,
            ai_settings,
            app,
    ...
    fn render_base_model_setting(
            ...
            Container::new(
                Flex::row()
                    ...
                    .with_children([
                        ...
                        appearance
                            .ui_builder()
                            .span(crate::tr!("settings", "ai-show-model-picker-prompt"))
                            .with_style(UiComponentStyles {
                                font_color: Some(
        ...
        let base_model_label = crate::tr!("settings", "ai-base-model-label");
        let base_model_desc = crate::tr!("settings", "ai-base-model-desc");
    ...
    fn render_codebase_context_outline_generation_setting(
        ...
        let toggle = render_ai_setting_toggle::<CodebaseContextEnabled>(
            crate::tr!("settings", "ai-codebase-context-label"),
            AISettingsPageAction::ToggleCodebaseContext,
        ...
        let codebase_context_description = vec![
            ...
            FormattedTextFragment::hyperlink(
                crate::tr!("settings", "ai-learn-more-link"),
    ...
    fn render_mcp_permissions_zero_state(
        ...
        let header = Container::new(render_body_item_label_with_icon::<AISettingsPageAction>(
            crate::tr!("settings", "settings-ai-mcp-call-servers-label").into(),
            Icon::Dataflow,
            Some(styles::header_font_color(
                ai_settings.is_any_ai_enabled(app),
                app,
        ...
        let subtext = {
            let subtext_fragments = vec![
                ...
                FormattedTextFragment::hyperlink_action(
                    crate::tr!("settings", "ai-add-server-link"),
                    AISettingsPageAction::OpenMCPServerCollection,
                ),
                FormattedTextFragment::plain_text(crate::tr!("settings", "settings-ai-mcp-or-separator")),
                FormattedTextFragment::hyperlink(
                    crate::tr!("settings", "settings-ai-mcp-learn-more-mcps-link"),
    ...
    fn render_mcp_permissions_with_servers(
        ...
        let permission_setting = self.render_execution_profile_dropdown(
            crate::tr!("settings", "settings-ai-mcp-call-servers-label"),
            Icon::Dataflow,
            ...
            || current_mcp_setting == ActionPermission::AgentDecides
        {
            let allowlist = self.render_mcp_list(
                crate::tr!("settings", "settings-ai-mcp-allowlist-label"),
                crate::tr!("settings", "settings-ai-mcp-allowlist-desc"),
            ...
            || current_mcp_setting == ActionPermission::AgentDecides
        {
            let denylist = self.render_mcp_list(
                crate::tr!("settings", "settings-ai-mcp-denylist-label"),
                crate::tr!("settings", "settings-ai-mcp-denylist-desc"),
...
impl SettingsWidget for AIInputWidget {
    ...
    fn render(
        ...
        if FeatureFlag::QueueSlashCommand.is_enabled() {
            let prompt_mode_label = crate::tr!("settings", "ai-default-prompt-submission-mode");
            let prompt_mode_desc = crate::tr!("settings", "ai-default-prompt-submission-mode-desc");
            widget_children.push(render_dropdown_item(
                appearance,
                &prompt_mode_label,
                Some(&prompt_mode_desc),
                None,
                LocalOnlyIconState::for_setting(
            ...
            if ai_settings.default_prompt_submission_mode == PromptSubmissionMode::Interrupt {
                let lrc_mode_label = crate::tr!("settings", "ai-default-lrc-submission-mode");
                let lrc_mode_desc = crate::tr!("settings", "ai-default-lrc-submission-mode-desc");
                widget_children.push(
    ...
    fn render_natural_language_detection_section(
        ...
        if FeatureFlag::AgentView.is_enabled() {
            static AUTODETECTION_DESCRIPTION_FRAGMENTS: LazyLock<Vec<FormattedTextFragment>> =
                LazyLock::new(|| {
                    vec![
                        FormattedTextFragment::plain_text(crate::tr!("settings", "ai-incorrect-detection-prefix")),
                        FormattedTextFragment::hyperlink(
            ...
            > = LazyLock::new(|| {
                vec![
                    ...
                    FormattedTextFragment::plain_text(
                        format!(" {} ", crate::tr!("settings", "settings-ai-incorrect-detection-prefix")),
                    ),
                    FormattedTextFragment::hyperlink(
                        crate::tr!("settings", "ai-let-us-know"),
                        "https://warpdotdev.typeform.com/to/offrTIpq",
        ...
        section
            .with_child(render_ai_setting_label::<AICommandDenylist>(
                crate::tr!("settings", "ai-nl-denylist-label"),
                is_toggleable,
                &view.local_only_icon_tooltip_states,
                app,
            ))
...
impl SettingsWidget for MCPServersWidget {
    ...
    fn render(
        ...
        let header = build_sub_header(
            appearance,
            crate::tr!("settings", "settings-ai-mcp-servers-header"),
            Some(styles::header_font_color(is_any_ai_enabled, app)),
        )
        .with_padding_bottom(HEADER_PADDING)
        .finish();
        ...
        let mcp_description = vec![
            FormattedTextFragment::plain_text(
                crate::tr!("settings", "settings-ai-mcp-servers-desc"),
            ),
            FormattedTextFragment::hyperlink(
                crate::tr!("settings", "settings-ai-mcp-learn-more-link"),
                "https://docs.warp.dev/agent-platform/capabilities/mcp",
            ),
        ];
        ...
        let file_based_mcp_toggle = if FeatureFlag::FileBasedMcp.is_enabled() {
            Some(
                Flex::column()
                    ...
                    .with_child({
                        let file_based_mcp_description = vec![
                            FormattedTextFragment::plain_text(
                                crate::tr!("settings", "settings-ai-mcp-auto-detect-desc"),
                            ),
                            FormattedTextFragment::hyperlink(
                                crate::tr!("settings", "ai-see-providers-link"),
        ...
        let button = render_full_pane_width_ai_button(
            &crate::tr!("settings", "settings-ai-mcp-manage-servers-link"),
            is_any_ai_enabled,
...
impl AIFactWidget {
    fn render_rules_toggle(
        ...
        let rules_description = vec![
            FormattedTextFragment::plain_text(
                crate::tr!("settings", "ai-rules-desc"),
            ),
            FormattedTextFragment::hyperlink(
                crate::tr!("settings", "ai-learn-more-link"),
    ...
    fn render_rule_suggestions_toggle(
        ...
        let description = render_ai_setting_description(
            crate::tr!("settings", "ai-suggest-rules-desc"),
            ai_settings.is_any_ai_enabled(app),
            app,
        );
    ...
    fn render_warp_drive_context_toggle(
        ...
        let description = render_ai_setting_description(
            crate::tr!("settings", "ai-knowledge-desc"),
            ai_settings.is_any_ai_enabled(app),
            app,
        );
...
impl SettingsWidget for AIFactWidget {
    ...
    fn render(
        ...
        let header = build_sub_header(
            appearance,
            crate::tr!("settings", "ai-knowledge-header"),
            Some(styles::header_font_color(is_any_ai_enabled, app)),
        )
        .with_margin_bottom(HEADER_PADDING)
        .finish();

        let manage_rules_text = crate::tr!("settings", "ai-manage-rules-link");
        let button = render_full_pane_width_ai_button(
            &manage_rules_text,
            is_any_ai_enabled,
...
impl VoiceWidget {
    fn render_voice_section(
        ...
        let mut column = Flex::column().with_child(render_ai_setting_toggle::<VoiceInputEnabled>(
            crate::tr!("settings", "ai-voice-input-header"),
            AISettingsPageAction::ToggleVoiceInput,
        ...
        let voice_input_description_text_fragments = vec![
            FormattedTextFragment::plain_text(
                crate::tr!("settings", "ai-voice-input-desc-prefix"),
            ),
            FormattedTextFragment::hyperlink("Wispr Flow", WISPR_FLOW_URL),
            FormattedTextFragment::plain_text(crate::tr!("settings", "ai-voice-input-desc-suffix")),
        ];
        ...
        if ai_settings.is_voice_input_enabled(app) {
            let voice_key_label = crate::tr!("settings", "ai-voice-key-label");
            let voice_key_desc = crate::tr!("settings", "ai-voice-key-desc");
    ...
    fn render(
        ...
        Flex::column()
            ...
            .with_child(
                build_sub_header(
                    appearance,
                    crate::tr!("settings", "ai-voice-label"),
                    Some(styles::header_font_color(is_any_ai_enabled, app)),
                )
                .with_padding_bottom(HEADER_PADDING)
                .finish(),
...
impl SettingsWidget for OtherAIWidget {
    ...
    fn render(
        ...
        if FeatureFlag::AgentView.is_enabled() {
            let mut agent_view_column = Flex::column()
                .with_child(render_ai_setting_toggle::<ShouldShowOzUpdatesInZeroState>(
                    crate::tr!("settings", "ai-show-oz-changelog-conversation"),
                    AISettingsPageAction::ToggleShowOzUpdatesInZeroState,
        ...
        column.add_child(render_ai_setting_toggle::<ShowConversationHistory>(
            crate::tr!("settings", "ai-show-conversation-history-tools"),
            AISettingsPageAction::ToggleShowConversationHistory,
        ...
        let thinking_label = crate::tr!("settings", "ai-thinking-display");
        column.add_child(render_dropdown_item(
            appearance,
            &thinking_label,
            Some(AI_THINKING_DISPLAY_DESC.get()),
            None,
            LocalOnlyIconState::for_setting(
        ...
        let orchestration_label = crate::tr!("settings", "ai-orchestration-message-display");
        let orchestration_desc = crate::tr!("settings", "ai-orchestration-message-display-desc");
        column.add_child(render_dropdown_item(
            appearance,
            &orchestration_label,
            Some(&orchestration_desc),
            None,
            LocalOnlyIconState::for_setting(
        ...
        if FeatureFlag::OpenWarpNewSettingsModes.is_enabled() {
            ...
            let layout_label = crate::tr!("settings", "ai-preferred-conversation-layout");
            column.add_child(render_dropdown_item(
                appearance,
                &layout_label,
                None,
...
impl SettingsWidget for CLIAgentWidget {
    ...
    fn render(
        ...
        let description_fragments = vec![
            FormattedTextFragment::plain_text(
                crate::tr!("settings", "ai-cli-toolbar-description-prefix") + " ",
            ),
        ...
        let mut column = Flex::column()
            .with_child(
                build_sub_header(
                    appearance,
                    crate::tr!("settings", "ai-third-party-cli-agents-header"),
                    Some(styles::header_font_color(true, app)),
                )
                .with_padding_bottom(HEADER_PADDING)
                .finish(),
        ...
        if is_footer_enabled {
            ...
            if FeatureFlag::CLIAgentRichInput.is_enabled() {
                ...
                let auto_show_toggle_label = render_body_item_label::<AISettingsPageAction>(
                    crate::tr!("settings", "ai-auto-toggle-rich-input-label"),
                    Some(styles::header_font_color(true, app)),
                    Some(AdditionalInfo {
                        ...
                        tooltip_override_text: Some(
                            crate::tr!("settings", "ai-cli-plugin-required-desc"),
                        ),
                    }),
                    LocalOnlyIconState::for_setting(
                ...
                column.add_child(
                    render_ai_setting_toggle::<AutoOpenRichInputOnCLIAgentStart>(
                        crate::tr!("settings", "ai-auto-open-rich-input-label"),
                        AISettingsPageAction::ToggleAutoOpenRichInputOnCLIAgentStart,
                ...
                column.add_child(render_ai_setting_toggle::<AutoDismissRichInputAfterSubmit>(
                    crate::tr!("settings", "ai-auto-dismiss-rich-input-label"),
                    AISettingsPageAction::ToggleAutoDismissRichInputAfterSubmit,
                ...
                column.add_child(render_ai_setting_toggle::<SubmitRichInputOnCtrlEnter>(
                    crate::tr!("settings", "ai-submit-rich-input-ctrl-enter"),
                    AISettingsPageAction::ToggleSubmitRichInputOnCtrlEnter,
            ...
            let command_list = {
                ...
                list_column.add_child(
                    appearance
                        .ui_builder()
                        .span(crate::tr!("settings", "ai-toolbar-commands-label"))
                        .with_style(UiComponentStyles {
                            font_size: Some(CONTENT_FONT_SIZE),
                            ..Default::default()
                        })
            ...
            let command_list_description = appearance
                .ui_builder()
                .paragraph(
                    crate::tr!("settings", "ai-toolbar-patterns-desc"),
                )
                .with_style(UiComponentStyles {
                    font_size: Some(appearance.ui_font_size()),
...
impl SettingsWidget for AgentAttributionWidget {
    ...
    fn render(
        ...
        let toggle = if state.is_forced_by_org {
            ui_builder
                ...
                .with_tooltip(TooltipConfig {
                    text: crate::tr!("settings", "ai-org-enforced-desc"),
        ...
        let toggle_row = build_toggle_element(
            render_body_item_label::<AISettingsPageAction>(
                crate::tr!("settings", "ai-enable-agent-attribution"),
        ...
        Flex::column()
            ...
            .with_child(render_ai_setting_description(
                crate::tr!("settings", "ai-agent-attribution-desc"),
                !state.is_disabled,
                app,
            ))
            .finish()
...
impl SettingsWidget for CloudAgentComputerUseWidget {
    ...
    fn render(
        ...
        let toggle_row = build_toggle_element(
            render_body_item_label::<AISettingsPageAction>(
                crate::tr!("settings", "settings-ai-cloud-agent-computer-use-label"),
        ...
        Flex::column()
            ...
            .with_child(
                build_sub_header(
                    appearance,
                    crate::tr!("settings", "ai-experimental-label"),
                    Some(styles::header_font_color(is_any_ai_enabled, app)),
                )
                .with_padding_bottom(HEADER_PADDING)
                .finish(),
            ...
            .with_child(toggle_row)
            .with_child(render_ai_setting_description(
                crate::tr!("settings", "ai-cloud-computer-use-desc"),
                !is_disabled,
                app,
            ))
            .finish()
...
impl SettingsWidget for CloudHandoffWidget {
    ...
    fn render(
        ...
        let tooltip_text = if cloud_convos_off {
            crate::tr!("settings", "ai-cloud-handoff-requires-conversations")
        } else {
            String::new()
        };
        ...
        let handoff_row = build_toggle_element(
            render_body_item_label::<AISettingsPageAction>(
                crate::tr!("settings", "ai-cloud-handoff-label"),
        ...
        let mut column = Flex::column()
            ...
            .with_child(
                build_sub_header(
                    appearance,
                    crate::tr!("settings", "ai-cloud-handoff-header"),
                    Some(styles::header_font_color(is_any_ai_enabled, app)),
                )
                .with_padding_bottom(HEADER_PADDING)
                .finish(),
            ...
            .with_child(render_ai_setting_description(
                crate::tr!("settings", "ai-cloud-handoff-desc"),
                !is_force_disabled,
                app,
            ));
        ...
        if ai_settings.is_cloud_handoff_enabled(app) {
                ...
                .is_supported_on_current_platform()
            {
                ...
                let auto_handoff_on_sleep_row = build_toggle_element(
                    render_body_item_label::<AISettingsPageAction>(
                        crate::tr!("settings", "ai-auto-handoff-sleep"),
                        Some(styles::header_font_color(true, app)),
                        None,
                        LocalOnlyIconState::Hidden,
                        ToggleState::Enabled,
                ...
                column.add_child(render_ai_setting_description(
                    crate::tr!("settings", "ai-auto-handoff-sleep-desc"),
                    true,
                    app,
                ));
            }
            ...
            let ampersand_row = build_toggle_element(
                render_body_item_label::<AISettingsPageAction>(
                    crate::tr!("settings", "ai-use-and-trigger-handoff"),
                    Some(styles::header_font_color(true, app)),
                    None,
                    LocalOnlyIconState::Hidden,
                    ToggleState::Enabled,
            ...
            column.add_child(render_ai_setting_description(
                crate::tr!("settings", "ai-use-and-trigger-handoff-desc"),
                true,
                app,
            ));
        }
...
impl ApiKeysWidget {
    fn new(ctx: &mut ViewContext<<Self as SettingsWidget>::View>) -> Self {
        ...
        let grok_connect_button = ctx.add_typed_action_view(|_| {
            ActionButton::new(crate::tr!("settings", "settings-ai-grok-connect-btn"), SecondaryTheme)
                .with_size(ButtonSize::Small)
                .on_click(|ctx| {
        ...
        let grok_connecting_button = ctx.add_typed_action_view(|_| {
            ActionButton::new(crate::tr!("settings", "settings-ai-grok-connecting-btn"), SecondaryTheme).with_size(ButtonSize::Small)
        });
        grok_connecting_button.update(ctx, |button, ctx| {
            button.set_disabled(true, ctx);
        });
        let grok_disconnect_button = ctx.add_typed_action_view(|_| {
            ActionButton::new(crate::tr!("settings", "settings-ai-grok-disconnect-btn"), DangerSecondaryTheme)
                .with_size(ButtonSize::Small)
                .on_click(|ctx| {
    ...
    fn render_provider_key_editors(
        ...
        column.add_child(self.render_api_key_input(
            appearance,
            crate::tr!("settings", "ai-openai-api-key-label"),
        ...
        column.add_child(self.render_api_key_input(
            appearance,
            crate::tr!("settings", "settings-ai-anthropic-api-key-label"),
        ...
        column.add_child(self.render_api_key_input(
            appearance,
            crate::tr!("settings", "settings-ai-google-api-key-label"),
    ...
    fn render_custom_inference_description(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        let text_fragments = vec![
            FormattedTextFragment::plain_text(
                crate::tr!("settings", "settings-ai-custom-inference-desc"),
            ),
            FormattedTextFragment::hyperlink(crate::tr!("settings", "settings-ai-custom-inference-learn-more-link"), CUSTOM_INFERENCE_LEARN_MORE_URL),
        ];
        let description = FormattedTextElement::new(
    ...
    fn render_custom_inference_info_icon(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let tooltip_text = FormattedText::new([FormattedTextLine::Line(vec![
            FormattedTextFragment::plain_text(
                crate::tr!("settings", "settings-ai-custom-inference-terms-prefix"),
            ),
            FormattedTextFragment::hyperlink(crate::tr!("settings", "settings-ai-custom-inference-terms-link"), CUSTOM_INFERENCE_TERMS_URL),
            FormattedTextFragment::plain_text(
                crate::tr!("settings", "settings-ai-custom-inference-terms-suffix"),
            ),
        ])]);
    ...
    fn render_grok_subscription_row(
        ...
        let label = Flex::row()
            ...
            .with_spacing(4.)
            .with_child(
                Text::new_inline(crate::tr!("settings", "settings-ai-grok-use-prefix"), appearance.ui_font_family(), CONTENT_FONT_SIZE)
                    .with_color(text_color.into())
                    .finish(),
            )
            .with_child(
            ...
            .with_child(
                Text::new_inline(
                    crate::tr!("settings", "settings-ai-grok-subscription-label"),
                    appearance.ui_font_family(),
                    CONTENT_FONT_SIZE,
                )
                .with_color(text_color.into())
        ...
        let description = Container::new(
            Text::new(
                crate::tr!("settings", "settings-ai-grok-connect-desc"),
                appearance.ui_font_family(),
                CONTENT_FONT_SIZE,
            )
        ...
        if let Some(tokens) = grok_tokens {
            let connected_text = match tokens.connected_at.map(DateTime::<Local>::from) {
                Some(connected_at) => crate::tr!("settings", "settings-ai-grok-connected-on", date = connected_at.format("%m/%d/%Y at %-I:%M%P").to_string()),
                // Tokens stored before the connection time was tracked.
                None => crate::tr!("settings", "settings-ai-grok-connected"),
            };
    ...
    fn render_warp_credit_fallback_toggle(
        ...
        let description = render_ai_setting_description(
            crate::tr!("settings", "settings-ai-warp-credit-fallback-agent-desc"),
            ai_settings.is_any_ai_enabled(app),
            app,
        );
...
impl SettingsWidget for ApiKeysWidget {
    ...
    fn render(
        ...
        if show_custom_inference {
            // Header row: "Custom inference" + info icon on left, crate::tr!("settings", "ai-add-custom-model") on right
            let header_left = Flex::row()
                .with_cross_axis_alignment(CrossAxisAlignment::Center)
                .with_child(
                    build_sub_header(
                        appearance,
                        crate::tr!("settings", "settings-ai-custom-inference-header"),
                        Some(styles::header_font_color(
                            custom_inference_controls_enabled,
                            app,
                        )),
            ...
            column.add_child(
                build_sub_header(
                    appearance,
                    crate::tr!("settings", "settings-ai-api-keys-header"),
                    Some(styles::header_font_color(is_any_ai_enabled, app)),
                )
                .with_padding_bottom(HEADER_PADDING)
                .finish(),
        ...
        if show_custom_inference {
            ...
            if !endpoints.is_empty() {
                column.add_child(
                    Container::new(
                        Text::new_inline(
                            crate::tr!("settings", "settings-ai-custom-endpoints-label"),
                            appearance.ui_font_family(),
                            CONTENT_FONT_SIZE,
                        )
                        .with_color(
        ...
        if !is_byo_enabled {
                ...
                UserWorkspaces::as_ref(app).current_team()
            {
                if team.billing_metadata.customer_type == CustomerType::Enterprise {
                    vec![
                        FormattedTextFragment::hyperlink(crate::tr!("settings", "settings-ai-byok-enterprise-link"), "mailto:sales@warp.dev"),
                        FormattedTextFragment::plain_text(
                            crate::tr!("settings", "settings-ai-byok-enterprise-desc"),
                        ),
                    ]
                } else {
                    let current_user_email = auth_state.user_email().unwrap_or_default();
                    ...
                    if has_admin_permissions {
                        vec![
                            FormattedTextFragment::hyperlink(
                                crate::tr!("settings", "settings-ai-byok-admin-link"),
                                upgrade_url,
                            ),
                            FormattedTextFragment::plain_text(crate::tr!("settings", "settings-ai-byok-admin-desc")),
                        ]
                    } else {
                        vec![FormattedTextFragment::plain_text(
                            crate::tr!("settings", "settings-ai-byok-non-admin-desc"),
                        )]
                    }
                }
                ...
                && auth_state.is_anonymous_or_logged_out()
            {
                vec![
                    FormattedTextFragment::hyperlink_action(
                        crate::tr!("settings", "settings-ai-byok-anonymous-link"),
                        AISettingsPageAction::SignupAnonymousUser,
                    ),
                    FormattedTextFragment::plain_text(crate::tr!("settings", "settings-ai-byok-anonymous-desc")),
                ]
            } else {
                let user_id = auth_state.user_id().unwrap_or_default();
                let upgrade_url = UserWorkspaces::upgrade_link(user_id);
                vec![
                    FormattedTextFragment::hyperlink(crate::tr!("settings", "settings-ai-byok-solo-link"), upgrade_url),
                    FormattedTextFragment::plain_text(crate::tr!("settings", "settings-ai-byok-solo-desc")),
                ]
            };
...
impl AwsBedrockWidget {
    fn new(ctx: &mut ViewContext<<Self as SettingsWidget>::View>) -> Self {
        ...
        let aws_auth_refresh_command_editor = ctx.add_typed_action_view(move |ctx| {
            ...
            let mut editor = EditorView::single_line(options, ctx);
            editor.set_placeholder_text(&crate::tr!("settings", "settings-ai-aws-login-placeholder"), ctx);
        ...
        let refresh_credentials_button = ctx.add_typed_action_view(|_| {
            ActionButton::new(REFRESH_LABEL.get(), SecondaryTheme)
    ...
    fn render_aws_bedrock_section(
        ...
        let toggle_description = if is_admin_enforced {
            crate::tr!("settings", "settings-ai-aws-bedrock-credentials-admin-desc")
        } else {
            crate::tr!("settings", "settings-ai-aws-bedrock-credentials-desc")
        };

        let mut column = Flex::column().with_spacing(16.).with_child(
            Flex::column()
                .with_child(render_ai_setting_toggle::<AwsBedrockCredentialsEnabled>(
            crate::tr!("settings", "settings-ai-aws-bedrock-credentials-label"),
                    AISettingsPageAction::ToggleAwsBedrockCredentialsEnabled,
        ...
        column.add_child(render_input(
            appearance,
            crate::tr!("settings", "settings-ai-aws-bedrock-login-command-label"),
        ...
        column.add_child(render_input(
            appearance,
            crate::tr!("settings", "settings-ai-aws-bedrock-profile-label"),
        ...
        let toggle = render_ai_setting_toggle::<AwsBedrockAutoLogin>(
            crate::tr!("settings", "settings-ai-aws-bedrock-auto-login-label"),
            AISettingsPageAction::ToggleAwsBedrockAutoLogin,
            auto_login_enabled,
            is_usage_enabled,
        ...
        let description = render_ai_setting_description(
            crate::tr!("settings", "settings-ai-aws-bedrock-auto-login-desc"),
            is_usage_enabled,
            app,
        );
        column.add_child(
    ...
    fn render(
        ...
        let column = Flex::column()
            ...
            .with_child(
                build_sub_header(
                    appearance,
                    crate::tr!("settings", "settings-ai-aws-bedrock-header"),
                    Some(styles::header_font_color(is_any_ai_enabled, app)),
                )
                .with_padding_bottom(HEADER_PADDING)
                .finish(),
