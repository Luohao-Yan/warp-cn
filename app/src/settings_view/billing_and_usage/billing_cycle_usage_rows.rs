...
impl SourceFilter {
    pub fn label(self) -> String {
        match self {
            SourceFilter::All => crate::tr!("billing", "filter-all"),
            SourceFilter::Local => crate::tr!("billing", "filter-local"),
            SourceFilter::Cloud => crate::tr!("billing", "filter-cloud"),
        }
    }
...
fn viewer_identity(app: &AppContext) -> (Option<String>, String) {
    ...
    let display_name = auth_state
        ...
        .unwrap_or_else(|| crate::tr!("billing", "your-usage"));
...
impl MemberUsageRow {
    ...
    fn for_other_members(entries: &[BillingCycleUsageEntry]) -> Self {
        ...
        Self {
            ...
            subject_uid: None,
            display_name: crate::tr!("billing", "other-members"),
            total_credits,
            total_cost_cents,
            segments,
            bar_max_credits: total_credits.max(1),
...
fn render_service_account_info_tooltip(appearance: &Appearance) -> Box<dyn Element> {
    ...
    let text = Text::new_inline(
        crate::tr!("billing", "automated-agent-description"),
...
fn render_member_header(
    ...
    let subheader = render_section_subheader(&crate::tr!("billing", "members"), appearance);
